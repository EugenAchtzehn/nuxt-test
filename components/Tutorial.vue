...
<template>
  ...
  >
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="border-indigo-700 border-2 p-2 m-2 text-center">
        <p>
          注意！ 本專案支援的 Tailwind 版本為 v2.2.19，比 v3 能設定的少很多。
          <br />
          請從
          <a class="text-blue-500" href="/_tailwind/"
            >localhost:${port || 3000}/_tailwind</a
          >
          查看能支援的設定！
        </p>
      </div>
